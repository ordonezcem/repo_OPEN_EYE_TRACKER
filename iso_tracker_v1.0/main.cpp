...
/* 
 * File:   main.cpp
 * Author: Cristian Emanuel Ordoñez
 *
...
int main(int argc, char** argv) {
    ...
    while(1)
    {
        ...
        mapadecentros_completo( imCONV, pdataim, pMAPA, pFX, pFY, pFXX, pFYY, pFXY, wimg, himg, ph_gauss1, ph_gauss2, pd1, pd1n, pp, ppn, pd2, rmin, rmax, &i_max_MAPA, &j_max_MAPA, &max_MAPA);
...
// 2) 
    ...
    while(1){
        ...
        mapadecentros_completo( imCONV2, pdataim3, pMAPA3, pFX2, pFY2, pFXX2, pFYY2, pFXY2, wimg, himg, ph_gauss1, ph_gauss2, pd1, pd1n, pp, ppn, pd2, rmin, rmax, &i_max_MAPA2, &j_max_MAPA2, &max_MAPA);
...
// 3) 
    ...
    while(1){
        ...
        mapadecentros_completo( imCONV2, pdataim3, pMAPA3, pFX2, pFY2, pFXX2, pFYY2, pFXY2, wimg, himg, ph_gauss1, ph_gauss2, pd1, pd1n, pp, ppn, pd2, rmin, rmax, &i_max_MAPA, &j_max_MAPA, &max_MAPA);
        ...
        if (pos_valida){ 
            ...
            forma_comando=1;          
            comandos( forma_comando, pv_contorno, im_control, use_beep, pvectorx, pvectory, im_ajuste, ancho_screen, alto_screen, i_max_MAPA, j_max_MAPA, ip_inicial, jp_inicial, fps, arduino );
